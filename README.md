...
The latest stable version of HTK-FS is available here:  
👉 [Download HTK-FS v1.0.0 (.zip)](https://github.com/mrxcodder/HTK-FS/releases/tag/v1.0.0)  

Released as a portable `.exe` under the MIT License.
